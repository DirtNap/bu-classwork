...
public class Assignment06 extends ShoppingRunner {
    ...
    public void doShopping(String name, QCShopper shopper, InputReader reader) {
        ...
        while (true) {
            reader.outputSource.printf("%s%s,  you currently have %s in your bank account.%n",
                    greeting, name, money.format(shopper.getBudget()));
            greeting = "";
            ...
            if (purchasedItems.length() > 0) {
                ...
                reader.outputSource.printf("for a total of %s.",
                        money.format(purchasedItems.getTotal()));
            } else {
            ...
            if (shopper.getShoppingList().length() > 0) {
                ...
                reader.outputSource.printf("for a total of %s.",
                        money.format(shopper.getShoppingList().getTotal()));
            } else {
