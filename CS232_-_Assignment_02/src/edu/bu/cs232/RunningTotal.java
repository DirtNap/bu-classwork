...
public class RunningTotal implements Iterable<RunningTotal.TotalRow>,
        Iterator<RunningTotal.TotalRow> {
    ...
    public class TotalRow {
        ...
        public TotalRow(double inputNumber, double sum, double avg, double min, double max,
                String fmt) {
    ...
    // Methods for finding the current value of an aggregate, or the value at a
    // particular point.
