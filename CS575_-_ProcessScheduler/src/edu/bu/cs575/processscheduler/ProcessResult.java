...
public class ProcessResult {
    ...
    public String toString() {
        return String.format("%d, %d, %d, %d, %.2f, %.2f, %.2f, %.2f", this.processId,
                this.priority, this.getTotalCPUTime(), this.totalBursts,
                this.getAverageBurstSize(), this.getAvgResponseTime(), this.getAvgWaitTime(),
                this.getAvgTurnaroundTime());
    }
}
