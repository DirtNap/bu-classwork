...
public class CircleCross {
    ...
    public void draw() {
        ...
        this.painter.drawArc(this.x - halfArc, this.y + this.size, arcSize, arcSize, 270, 180);
        this.painter.drawOval(this.x + halfArc, this.y + halfArc, outlineSize, outlineSize);
        this.painter.fillOval(this.x + halfArc + outlineWidth, this.y + halfArc + outlineWidth,
                this.size, this.size);
        this.painter.drawArc(this.x + outlineSize + halfArc, this.y + this.size, arcSize, arcSize,
                90, 180);
        this.painter.drawArc(this.x + this.size, this.y + halfArc + outlineSize, arcSize, arcSize,
                0, 180);
    }
